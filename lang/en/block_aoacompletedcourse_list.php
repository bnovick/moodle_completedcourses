...
/**
 * Strings for component 'block_aoacompletedcourse_list', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   block_aoamcompletedcourse_list
...
$string['morecourses'] = 'View all completed courses';
$string['nocert'] = 'Certificate not available. Please contact support.';
$string['pluginname'] = 'AOA - Completed Courses';
